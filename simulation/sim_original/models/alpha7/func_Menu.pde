...
int getCurrentUnit()                  {  return offlineUnit; }
int getCurrentLesson()                {  return offlineLesson; }
int getCurrentSimulation()            {  return offlineSim; }
void setCurrentUnit(int input)        {  offlineUnit = input; }
void setCurrentLesson(int input)      {  offlineLesson = input; }
void setCurrentSimulation(int input)  {  offlineSim = input; }
