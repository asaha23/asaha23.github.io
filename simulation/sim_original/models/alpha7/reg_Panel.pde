...
/* dimensions -------------------------------------- */
  ...
  float h() {
    ...
    if (type.equals("menu"))            { result = mod; }
...
/* menus -------------------------- */
  ...
  void updateMenu() {
    updateMenus();
    menuPanel.setDimensions(headerArea.x, headerArea.y, headerArea.w, headerArea.h);
    menuPanel.setTitleBarOff();
  }
  void displayMenu() {
    displayMenus();
  }
